...
//Modified Date:20May20255
	...
	//21-02-2025: Introduce wall in the z-direction
	//29-03-2025: Correction of energy calculation
	//20-05-2025: Bead-Wall interaction energy is introduced.
	//15-08-2025: Bead-wal interaction energy is used in the energy calculation
...
double Ex=200.0;//Bead overlap energy
...
void fmoves(int cnum,int r)
{
	...
	//Wall boundary condition in the z-direction
	if (fpos.ez<0||fpos.ez>lz-1)
		reset=1;
	else
		reset=0;
